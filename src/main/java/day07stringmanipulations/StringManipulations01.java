...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //Ornek1: "t" string indeki tum rakamlari "*" ceviriniz
        String t1 = t.replaceAll("[0-9]", "*");
        System.out.println(t1);//Ali ** yasindadir!...

        //Ornek 2: "t" string indeki tum rakamve harfleri "!" e ceviriniz
        String t2 = t.replaceAll("[0-9a-zA-Z]","!");
        System.out.println(t2);//!!! !! !!!!!!!!!!!...

        //Ornek 3: "t" string indeki tum sesli harfleri "?" ne ceviriniz
        String t3 = t.replaceAll("[aeiuoAEIUO]","?");
        System.out.println(t3);//?l? 13 y?s?nd?d?r!...

        //Ornek 4: "t" string indeki kucuk harfler disindaki tum characterleri "<>" e ceviriniz
        String t4 = t.replaceAll("[^a-z]" ,"<>");
        System.out.println(t4);//<>li<><><><>yasindadir<><><><>

        //Ornek 5: "t" string indeki tum harfler disindaki caharacterleri "+" ya ceviriniz
        String t5 = t.replaceAll("[^a-zA-Z]" ,"+");
        System.out.println(t5);//Ali++++yasindadir++++

        //Ornek 6: "t" string indeki spaceler disindaki tum characterleri "?" ne ceviriniz
        String t6 = t.replaceAll("[^ ]","?");
        System.out.println(t6);//??? ?? ??????????????

        //Ornek 7: "t" string indeki sesli harfler disindaki tum characterleri "&" e ceviriniz
