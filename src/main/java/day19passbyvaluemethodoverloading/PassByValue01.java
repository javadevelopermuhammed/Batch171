...
public class PassByValue01 {
    public static void main(String[] args) {
        ...
        //Java methoda gonderirken orjinal degeri degil, kopyasini gonderir ve degisen deger koya deger olur
        ...
        //normalde discount methodu ile indirim yaptik ama buradaki deger hâla orjinal
        System.out.println(shirtPrice);//100

        shirtPrice=discount("veteran",shirtPrice);
        System.out.println("Shit Price Kampanya "+shirtPrice);
